...
(async () => {
  ...
  await page.click(
    'text=The opening of the first book of the New Testament reflects a clear Jewish'
  );
  ...
  await page.click(
    'text=1In those days, John the Baptizer came, preaching in the wilderness of Judea'
  );
